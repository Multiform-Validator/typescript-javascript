...
```html
<script type="module">
	import multiform-validator from "https://cdn.jsdelivr.net/npm/multiform-validator@2.5.0/+esm"
</script>
```
...
```html
<script src="https://unpkg.com/multiform-validator@2.5.0/dist/cjs/index.cjs"></script>
```
...
```html
<script type="module">
	import multiformValidator from "https://cdn.jsdelivr.net/npm/multiform-validator@2.5.0/+esm";
